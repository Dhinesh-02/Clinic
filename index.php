...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        <h2>SMILE... </h2>
                        <h2>Dental clinic</h3>
                        <p>To make an appointment. Please <span class="label label-danger">login</span> to make an appointment. </p>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                            <span class="fa fa-landline"></span>
                        </div>
                        <div class="col-xs-10">
                            <h4>contact</h4>
                            <p>+140452.....</p>
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
                <p class="pull-center small">ADMIN LOGIN <a href ="http://localhost/DoctorAppointmentSystem/adminlogin.php">    ADMIN </a></p>
            </div>
        </div>
        <!-- footer end -->
    </div>
